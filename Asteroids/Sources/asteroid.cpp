...
namespace Asteroids
{
    ...
    */
    ...
    Asteroid::Asteroid(float width, float height, int difficulty, Camera camera) : shader("../Asteroids/Shaders/asteroid.vs", "../Asteroids/Shaders/asteroid.fs"),
    ...
    Asteroid::Asteroid(float width, float height, int difficulty, Camera camera, float angle) : shader("../Asteroids/Shaders/asteroid.vs", "../Asteroids/Shaders/asteroid.fs"),
                                                                                                angle(angle),
                                                                                                speed(ASTEROID_MOVEMENT_SPEED * difficulty)
    {
        init();
